...
class FamilyChildGateway extends QueryableGateway implements ScrubbableGateway
{
    ...
    public function selectChildByFamilyID($gibbonFamilyID, $gibbonSchoolYearID)
    {
        $data = ['gibbonFamilyID' => $gibbonFamilyID, 'gibbonSchoolYearID' => $gibbonSchoolYearID, 'today' => date('Y-m-d')];
